...
parser.add_argument('--data-dir', default='vocab/test_0.25w_data.pkl', type=str)
parser.add_argument('--vocab-file', default='vocab/vocab.json', type=str)
parser.add_argument('--checkpoint-path', default='checkpoints/deepsc-AWGN-advanced/checkpoint_best.pth', type=str)
parser.add_argument('--channel', default='AWGN', type=str, help='Please choose AWGN, Rayleigh, Rician, or None')
parser.add_argument('--output-dir', default='test', type=str, help='Output directory for saving plots')
parser.add_argument('--output-name', default='performance_comparison_AWGN_original.png', type=str)
...
def performance(args, SNR, net, vocab_data, vocab_name, original_vocab_data=None):
    ...
    test_eur = EurDataset('test_0.25w')
